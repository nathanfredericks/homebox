  ...
  const sectionDefs = computed<SectionDef[]>(() => [
    {
      id: "options",
      fields: [
        { key: "allowRegistration", label: t("admin.settings.options.allow_registration"), type: "boolean" },
        ...
        { key: "githubReleaseCheck", label: t("admin.settings.options.github_release_check"), type: "boolean" },
        {
          key: "hostname",
    ...
    },
    {
      id: "labelmaker",
      fields: [
        { key: "width", label: t("admin.settings.labelmaker.width"), type: "number" },
        { key: "height", label: t("admin.settings.labelmaker.height"), type: "number" },
        { key: "padding", label: t("admin.settings.labelmaker.padding"), type: "number" },
        { key: "margin", label: t("admin.settings.labelmaker.margin"), type: "number" },
        { key: "fontSize", label: t("admin.settings.labelmaker.font_size"), type: "number" },
        { key: "dynamicLength", label: t("admin.settings.labelmaker.dynamic_length"), type: "boolean" },
        { key: "printCommand", label: t("admin.settings.labelmaker.print_command"), type: "text", nullable: true },
        {
          key: "additionalInformation",
          label: t("admin.settings.labelmaker.additional_information"),
          type: "text",
          nullable: true,
        },
        {
          key: "labelServiceUrl",
          label: t("admin.settings.labelmaker.label_service_url"),
          type: "text",
          nullable: true,
        },
        {
          key: "labelServiceTimeout",
          label: t("admin.settings.labelmaker.label_service_timeout"),
          type: "durationSeconds",
        },
        {
          key: "regularFontPath",
          label: t("admin.settings.labelmaker.regular_font_path"),
          type: "text",
          nullable: true,
        },
        { key: "boldFontPath", label: t("admin.settings.labelmaker.bold_font_path"), type: "text", nullable: true },
      ],
    },
    {
      id: "notifier",
