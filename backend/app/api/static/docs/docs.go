...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.AdminSettingsOut"
                        }
                    }
                }
            }
        },
        "/v1/admin/settings/algolia/reindex": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/v1/admin/settings/{section}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Sparse section override",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/public/attachments/{attachment_id}": {
            "get": {
    ...
    "definitions": {
        ...
        "config.AlgoliaConf": {
            ...
            "properties": {
                ...
                "fields": {
                    "description": "Fields is a comma-separated allowlist of record fields to push. Empty\nmeans every field. objectID and groupId are always included.",
                    "type": "string"
                },
                "indexName": {
                    "type": "string"
                ...
                "publicBaseUrl": {
                    "description": "PublicBaseURL is the externally reachable base URL used to build\nthumbnail links. Falls back to options.hostname when empty.",
                    "type": "string"
                },
                "publicImageUrls": {
                    "description": "PublicImageURLs includes an unauthenticated HMAC-signed thumbnail URL in\neach record so external search UIs can render item images.",
                    "type": "boolean"
                },
                "reindexInterval": {
                    "description": "ReindexInterval is a Go duration string (\"24h\"); kept as a string so it\nround-trips through the settings API and UI without nanosecond math.",
                    "type": "string"
                }
            }
        },
        ...
        "config.NotifierConf": {
            ...
            "properties": {
                "allowNets": {
                    "description": "AllowNets will allow specific networks through for generic notifiers.\nIf this is filled, only these networks will be allowed through.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "blockBogonNets": {
                    "description": "BlockBogonNets will prevent generic notifiers from sending to bogon networks. (Reserved IPs)",
                    "type": "boolean"
                },
                "blockCloudMetadata": {
                    "description": "BlockCloudMetadata will prevent generic notifiers from sending to known cloud metadata IPs.",
                    "type": "boolean"
                },
                "blockLocalNets": {
                    "description": "BlockLocalNets will prevent generic notifiers from sending to local networks. (RFC1918)",
                    "type": "boolean"
                },
                "blockLocalhost": {
                    "description": "BlockLocalhost will prevent generic notifiers from sending to localhost.",
                    "type": "boolean"
                },
                "blockNets": {
                    "description": "BlockNets will block specific networks from generic notifiers.\nIf this is filled, these networks will be blocked from generic notifiers.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "settings.Resolved": {
            ...
            "properties": {
                ...
                "barcode": {
                    "$ref": "#/definitions/config.BarcodeAPIConf"
                },
                "labelmaker": {
                    "$ref": "#/definitions/config.LabelMakerConf"
                },
                "mailer": {
                    "$ref": "#/definitions/config.MailerConf"
                },
                "notifier": {
                    "$ref": "#/definitions/config.NotifierConf"
                },
                "options": {
                    "$ref": "#/definitions/config.Options"
                },
                "thumbnail": {
                    "$ref": "#/definitions/config.Thumbnail"
                }
            }
        },
        "templatefield.Type": {
