...
type NotifierConf struct {
	...
	AllowNets []string `json:"allowNets" yaml:"allow_nets"`
	...
	BlockNets []string `json:"blockNets" yaml:"block_nets"`
	// BlockLocalhost will prevent generic notifiers from sending to localhost.
	BlockLocalhost bool `json:"blockLocalhost" yaml:"block_localhost" conf:"default:false"`
	// BlockLocalNets will prevent generic notifiers from sending to local networks. (RFC1918)
	BlockLocalNets bool `json:"blockLocalNets" yaml:"block_local_nets" conf:"default:false"`
	// BlockBogonNets will prevent generic notifiers from sending to bogon networks. (Reserved IPs)
	BlockBogonNets bool `json:"blockBogonNets" yaml:"block_bogon_nets" conf:"default:true"`
	// BlockCloudMetadata will prevent generic notifiers from sending to known cloud metadata IPs.
	BlockCloudMetadata bool `json:"blockCloudMetadata" yaml:"block_cloud_metadata" conf:"default:true"`
}
