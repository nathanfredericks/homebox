...
func (_u *RoleUpdate) AddPermissions(v ...*RolePermission) *RoleUpdate {
...
func (_u *RoleUpdate) RemovePermissions(v ...*RolePermission) *RoleUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddPermissions adds the "permissions" edges to the RolePermission entity.
func (_u *RoleUpdateOne) AddPermissions(v ...*RolePermission) *RoleUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemovePermissions removes "permissions" edges to RolePermission entities.
func (_u *RoleUpdateOne) RemovePermissions(v ...*RolePermission) *RoleUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
