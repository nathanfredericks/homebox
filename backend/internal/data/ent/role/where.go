...
func IsSuperAdmin(v bool) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldIsSuperAdmin, v))
}
...
func IsSuperAdminEQ(v bool) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldIsSuperAdmin, v))
}

// IsSuperAdminNEQ applies the NEQ predicate on the "is_super_admin" field.
func IsSuperAdminNEQ(v bool) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldIsSuperAdmin, v))
}
