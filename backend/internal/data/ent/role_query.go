...
func (_q *RoleQuery) QueryPermissions() *RolePermissionQuery {
...
func (_q *RoleQuery) WithPermissions(opts ...func(*RolePermissionQuery)) *RoleQuery {
	query := (&RolePermissionClient{config: _q.config}).Query()
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withPermissions; query != nil {
		if err := _q.loadPermissions(ctx, query, nodes,
			func(n *Role) { n.Edges.Permissions = []*RolePermission{} },
			func(n *Role, e *RolePermission) { n.Edges.Permissions = append(n.Edges.Permissions, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *RoleQuery) loadPermissions(ctx context.Context, query *RolePermissionQuery, nodes []*Role, init func(*Role), assign func(*Role, *RolePermission)) error {
