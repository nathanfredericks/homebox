...
func (_c *RoleCreate) SetIsSuperAdmin(v bool) *RoleCreate {
	_c.mutation.SetIsSuperAdmin(v)
	return _c
}

// SetNillableIsSuperAdmin sets the "is_super_admin" field if the given value is not nil.
func (_c *RoleCreate) SetNillableIsSuperAdmin(v *bool) *RoleCreate {
	if v != nil {
...
func (_c *RoleCreate) AddPermissions(v ...*RolePermission) *RoleCreate {
...
func (_c *RoleCreate) check() error {
	...
	if _, ok := _c.mutation.IsSuperAdmin(); !ok {
		return &ValidationError{Name: "is_super_admin", err: errors.New(`ent: missing required field "Role.is_super_admin"`)}
	}
	return nil
}
...
func (_c *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.IsSuperAdmin(); ok {
		_spec.SetField(role.FieldIsSuperAdmin, field.TypeBool, value)
